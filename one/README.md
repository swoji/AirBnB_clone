...
This software is a command interpreter similar to a Bash shell but limited to a specific use-case; management of objects in the AirBnB Clone:
...
```
git clone https://github.com/swoji/AirBnB_clone.git
```
...
## Authors
* **David Okuku** <[swoji](https://github.com/swoji)>
* **Beulah Alex** <[Beu-lah](https://github.com/Beu-lah)>
